...
<html lang="{{ app()->getLocale() }}">
    ...
    <body>
        <div id="container">
            <!-- Menus -->
            <a id="logo" href="#">
                <img src="/images/JustREIN.png" width="24px" length="100px" />
            </a>
            <div id="top-menu">
              <div id="top-menu-left">
                <a href="#"><span class="menu-item active">Dashboard</span></a>
                <a href="#"><span class="menu-item">Partners</span></a>
                <a href="#"><span class="menu-item">Reports</span></a>
                <a href="#"><span class="menu-item">Logs</span></a>
                <a href="#"><span class="menu-item">Motorists</span></a>
              </div>
            </div>
            <!-- End Menus -->
            ...
            <div id="left-column">
              ...
              <div class="vertical-menu">
                ...
                <a href="#" class="menu-icon active">Partners</a>
                <a href="#" class="menu-icon active">Reports</a>
                <a href="#" class="menu-icon active">Logs</a>
                <a href="#" class="menu-icon active">Motorists</a>
              </div>
            </div>
            <!-- End Left Column -->
